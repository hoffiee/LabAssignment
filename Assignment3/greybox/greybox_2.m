...
data_1 = iddata(dTheta1_grey(1:ceil(end/2)),Voltage_grey(1:ceil(end/2)),Ts);
data_2 = iddata(dTheta1_grey(ceil(end/2):end),Voltage_grey(ceil(end/2):end),Ts);
...
disp('Covariance for Dataset / 2')
cov([sys_est_1.Report.Parameters.ParVector(1) sys_est_2.Report.Parameters.ParVector(1)])